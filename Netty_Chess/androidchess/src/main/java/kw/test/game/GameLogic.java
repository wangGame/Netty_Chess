...
import kw.test.xqwlight.Position;
import kw.test.xqwlight.Search;

import java.util.ArrayDeque;
import java.util.Deque;
import java.util.concurrent.ExecutorService;
import java.util.concurrent.Executors;
import static kw.test.game.GameConfig.RESP_CAPTURE;
import static kw.test.game.GameConfig.RESP_CAPTURE2;
import static kw.test.game.GameConfig.RESP_CHECK;
import static kw.test.game.GameConfig.RESP_CHECK2;
import static kw.test.game.GameConfig.RESP_CLICK;
import static kw.test.game.GameConfig.RESP_DRAW;
import static kw.test.game.GameConfig.RESP_ILLEGAL;
import static kw.test.game.GameConfig.RESP_LOSS;
import static kw.test.game.GameConfig.RESP_MOVE;
import static kw.test.game.GameConfig.RESP_MOVE2;
import static kw.test.game.GameConfig.RESP_WIN;
