package kw.test.screen.view;

import com.badlogic.gdx.graphics.Texture;
import com.badlogic.gdx.graphics.g2d.Batch;
import com.badlogic.gdx.scenes.scene2d.Group;
import com.badlogic.gdx.scenes.scene2d.ui.Image;
import kw.test.game.GameConfig;
import kw.test.game.GameLogic;
import kw.test.game.IGameView;


public class LoadingView extends Group implements IGameView {
...
//        setBackgroundResource(R.drawable.board);
        addActor(new Image(new Texture("")));
        loadBitmapResources();
    }
...
//            }
            mPiecesBitmap[i] = new Image(new Texture("qizi/ba.png"));
